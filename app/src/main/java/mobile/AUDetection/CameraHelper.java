...
@SuppressLint("NewApi") 
public class CameraHelper extends OrientationEventListener implements Callback, PreviewCallback {
	...
	int displayRotation;
	public CameraHelper(Context context, Detector detector, SurfaceView providedSurfaceView) {
		super(context);
	...
	void startDetection() {
		this.camera = this.cameraFacade.acquireCamera();
	...
	private void initCameraParams() {
		...
		cameraParams.setPreviewFormat(ImageFormat.NV21);//ͼ��Ԥ�������ʽ
	...
	static class CameraFacade {
		...
		Camera acquireCamera() throws IllegalStateException {
			int cameraToOpen = 1;
